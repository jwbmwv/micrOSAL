...
// OSAL_BACKEND_HAS_PTHREAD from the same four backend macros).
#if !defined(OSAL_BACKEND_HAS_PTHREAD) && (defined(OSAL_BACKEND_POSIX) || defined(OSAL_BACKEND_LINUX) || \
                                           defined(OSAL_BACKEND_NUTTX) || defined(OSAL_BACKEND_QNX))
