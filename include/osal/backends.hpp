...
// ---------------------------------------------------------------------------
    ...
    defined(OSAL_BACKEND_QNX) || defined(OSAL_BACKEND_CMSIS_RTOS) || defined(OSAL_BACKEND_CMSIS_RTOS2)
...
#error "OSAL: no backend selected.  Define exactly one of: "    \
         ...
         "OSAL_BACKEND_QNX, OSAL_BACKEND_CMSIS_RTOS, "            \
...
/// Covers POSIX, Linux, NuttX and QNX — all of which expose the full
