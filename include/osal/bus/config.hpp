...
/// @file config.hpp
/// @brief OSAL bus layer compile-time configuration
...
/// @brief Zephyr-native bus backend.
/// @details On real Zephyr builds this uses Zephyr @c k_msgq primitives for
///          point-to-point channels and per-subscriber pub/sub queues.
///          Premium observer registration and dispatch are implemented in the
///          backend; routing and zero-copy publish still use the portable
///          wrapper behavior.
