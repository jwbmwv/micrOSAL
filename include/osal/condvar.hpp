...
///          Linux, NuttX, QNX, Zephyr, ChibiOS, VxWorks) the native primitive
///          is used.  On all other backends, an emulated implementation using
///          OSAL mutex + semaphore is provided automatically.
///
///          Usage:
///          @code
///          osal::mutex m;
