...
| [backend_map.puml](backend_map.puml) | Component | 15 backends grouped by family (POSIX, commercial RTOS, specialty, ARM CMSIS, bare-metal) with capability highlights |
| [capability_matrix.puml](capability_matrix.puml) | Map | Per-backend feature support matrix (17 capability flags × 15 backends) |
